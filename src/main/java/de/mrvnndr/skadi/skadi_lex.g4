...
tokens {HOST_CODE, NAME, SECTION_SEP, COMMA, DASH, CHAR, CIRCUMFLEX, BACKSLASH, VERT_BAR, DOLLAR,
STAR, PLUS, DOT, QUESTION_MARK, PAREN_OPEN, PAREN_CLOSED, CURLY_OPEN, CURLY_CLOSED, COLON, ZERO, NON_ZERO_DIGIT,
BRACKET_OPEN, BRACKET_CLOSED, PATTERN_CHAR, UNDERLINE, COMMENT, REGEX_END, ACTION_END,
CH_a, CH_b, CH_c, CH_d, CH_e, CH_f, CH_n, CH_r, CH_s, CH_t, CH_v, CH_w, CH_x,
CH_A, CH_B, CH_C, CH_D, CH_E, CH_F, CH_S, CH_W}
